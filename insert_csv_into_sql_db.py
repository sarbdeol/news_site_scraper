...
def insert_into_db(csv_file_path):
    try:
        ...
        connection = mysql.connector.connect(
            ...
            host=os.getenv("HOST_NAME"),           # Replace with your database host
            port=3306,                          # Default MySQL port
            # user='aktywwwni_hotelexplorer_en',  # Your username
            user=os.getenv("USERNAME"),  # Your username
...
def generate_news(short_sentence):
    ...
    payload = json.dumps({
        ...
        "messages": [
            ...
            },
            {
                ...
                "content": f" {os.getenv('NEWS_PROMPT')}: {short_sentence}"
            }
        ],
        "temperature": 0.7,
        "max_tokens": 500,
    ...
    headers = {
        ...
        'Authorization': "Bearer "+os.getenv("OPENAI_API_KEY"),  # Replace with your actual API key
    }
    ...
    payload = json.dumps({
        ...
        "messages": [
            ...
            },
            {
                ...
                "content": f" {os.getenv('SUBTITLE_PROMPT')}: {short_sentence}"
            }
        ],
        "temperature": 0.7,
        "max_tokens": 500,
    ...
    payload = json.dumps({
        ...
        "messages": [
            ...
            },
            {
                ...
                "content": f"{os.getenv('TITLE_PROMPT')}: {short_sentence}"
            }
        ],
        "temperature": 0.7,
        "max_tokens": 500,
    ...
    payload = json.dumps({
        ...
        "messages": [
            ...
            },
            {
                ...
                "content": f"{os.getenv('DATE_FORMAT')}:{date}"
            }
        ],
        "temperature": 0.7,
        "max_tokens": 500,
